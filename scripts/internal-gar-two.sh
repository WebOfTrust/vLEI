...
kli incept --name intgar2 --alias intgar2 --file scripts/single-sig-incept.json

kli oobi resolve --name intgar2 --alias intgar2 --oobi-alias "GLEIF Root" --oobi http://20.121.171.161:7723/.well-known/keri/oobi/gleif-root
