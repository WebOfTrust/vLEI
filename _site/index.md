...
1. Review the [Credentials Overview](credentials.md) to understand the credential types
2. Study the [Ecosystem Documentation](vlei-credential-ecosystem.md) for detailed workflows
3. Reference the schema documentation for specific credential implementations
4. Use the [Dependency Graph](vlei-dependency-graph.md) to understand credential relationships
